...
class CreateSexoffendersKansas extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ks_offenders', function (Blueprint $table) {
            $table->increments('id');
            $table->string('so_id');
        ...
        Schema::create('ks_offenses', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::create('ks_profiles', function (Blueprint $table) {
            $table->increments('id');
            $table->string('url');
        ...
        Schema::create('ks_counties', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            $table->string('county_id',20);
    ...
    {
        Schema::drop('ks_offenders');
        Schema::drop('ks_offenses');
        Schema::drop('ks_profiles');
        Schema::drop('ks_counties');
    }
}
